...
Add it to your [Meteor](http://meteor.com) app with `meteor add num3a:camera`. The api is super simple - there is only one function to call.
...
- `correctOrientation` Rotate the image to correct the orientation of the device during capture.
